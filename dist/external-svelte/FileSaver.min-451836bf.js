import { g as j, c as s } from "./embed-bb8ceb60.js";
var E = { exports: {} };
(function(b, S) {
  (function(p, i) {
    i();
    ...
    var a = typeof window == "object" && window.window === window ? window : typeof self == "object" && self.self === self ? self : typeof s == "object" && s.global === s ? s : void 0, m = a.navigator && /Macintosh/.test(navigator.userAgent) && /AppleWebKit/.test(navigator.userAgent) && !/Safari/.test(navigator.userAgent), u = a.saveAs || (typeof window != "object" || window !== a ? function() {
      ...
      if (o = o || open("", "_blank"), o && (o.document.title = o.document.body.innerText = "downloading..."), typeof e == "string")
        return i(e, t, r);
      var n = e.type === "application/octet-stream", h = /constructor/i.test(a.HTMLElement) || a.safari, w = /CriOS\/[\d]+/.test(navigator.userAgent);
      if ((w || n && h || m) && typeof FileReader < "u") {
        var d = new FileReader();
        d.onloadend = function() {
          var c = d.result;
          c = w ? c : c.replace(/^data:[^;]*;/, "data:attachment/file;"), o ? o.location.href = c : location = c, o = null;
        }, d.readAsDataURL(e);
      } else {
    ...
    a.saveAs = u.saveAs = u, b.exports = u;
  });
})(E);
var L = E.exports;
const R = /* @__PURE__ */ j(L), A = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: R
